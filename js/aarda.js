...
tipButton.addEventListener('click', () => {
  setTimeout(() => {
  window.location.href = 'https://bynogame.com/tr/destekle/shadokiller';
     }, 1600);
});
// yapmak için yarım saat döndüm dolaştım halbu ki yeni event açınca her şey halloluyomuş...  xxd 
